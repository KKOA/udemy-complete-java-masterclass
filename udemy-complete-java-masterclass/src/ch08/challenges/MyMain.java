...
public class MyMain {
	public static void main() {
		...
		System.out.println("Chapter 8 Challenges");
		System.out.println();
		...
		System.out.println("Total Price : " + burger1.calculatePrice());
		System.out.println();
		...
		System.out.println("Total Price : " + burger2.calculatePrice());
		System.out.println();

		Burger burger3 = new Burger("Basic", "Naan", "Turkey", 4.5);
		System.out.println("Total Price : " + burger3.calculatePrice());
		System.out.println();

		HealthyBurger burger4 = new HealthyBurger("Turkey", 1);
...
//		burger4.addBurgerAddition3("Tomato", 0.35);
		...
		System.out.println("Total Price : " + burger4.calculatePrice());
